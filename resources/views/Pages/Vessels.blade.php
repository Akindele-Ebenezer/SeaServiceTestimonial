...
<div class="content-data">
    ...
    <div class="inner vessel-information">
        <h1><img src="{{ asset('images/cruise-ship.png') }}" alt=""> Asaga ID: &nbsp; <span class="id">#3981433</span><button class="cancel-vessel-information-button">✖</button></h1>
        <div class="inner-x">
            <div class="data data-1">
                <h2>Vessel Information</h2>
                <ul>
                    <li>
                        <span>MMSI</span><span><strong>42795</strong></span>
                    </li>
                    <li>
                        <span>MMSI</span><span><strong>42795</strong></span>
                    </li>
