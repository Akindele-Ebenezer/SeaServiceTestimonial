    ...
    <div class="list tooltip-x">
        ...
        <div class="inner -x">  
            ...
            <strong class="notification-wrapper">  
                ...
                "></span>
                <span class="">{{ $Vessel->VesselName  ? 'ready' : $Availability_STATUS->Status ?? 'ready' }}
    ...
    <div class="list tooltip-x"> 
        ...
        <div class="inner -x">  
            ...
            <strong class="notification-wrapper">  
                ...
                <span class="imo availability-status {{ $Availability_STATUS->Status ?? 'ready' == 'IDLE' ? 'ready' : $Availability_STATUS->Status ?? 'ready' }}
                    status-1">   
                    {{ (!empty($Availability_STATUS->TillNow) == 'YES') ? $Availability_STATUS->Status ?? 'READY' : (($Availability_STATUS->Status ?? 'READY TO GO') == 'IDLE' ? 'READY' : $Availability_STATUS->Status ?? 'READY') ?? 'READY TO GO' }} 
                </span>
            </strong>  
