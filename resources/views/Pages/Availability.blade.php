            ...
            <div class="div tracking">
                ...
                <table>
                    ...
                    @php 
                        ...
                        $Vessel_STARTIME = \DB::table('vessel_availabilities')->where('Vessel', $Vessel->VesselName)->where('StartDate', $STARTDATE)->orderBy('DateIn', 'DESC')->orderBy('TimeIn', 'DESC')->paginate(30);
                    @endphp
                    <tr>
            ...
            <div class="div recent-workflow" style="width: 100%">
                ...
                <div class="canvas"> 
                    <div class="inner-x">
                        ...
                        <span style="height: 1.5em; width: {{ count($NumberOfVessels_INSPECTION_LASTMONTH) }}%; background: #ff832b"></span>
                        <span style="height: 1.5em; width: {{ count($NumberOfVessels_BUNKERY_LASTMONTH) }}%; background: #8a3ffc"></span>
                        <span style="height: 1.5em; width: {{ count($NumberOfVessels_IDLE_LASTMONTH) }}%; background: #fff"></span>
                    </div>
                    <div class="inner-x">
                        <span>- 2 months </span>
