...
<div class="vessel-content"> 
    ...
    <div class="list">
        <div class="inner -x">
            <span class="vessel">ASAGA</span><strong>Sea dredging <br> <span class="imo">09-04-2024</span></strong> 
            <div class="inner">
...
<div class="content-data dashboard"> 
    <div class="dashboard-inner"> 
        <h1><svg class="-x" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m136-240-56-56 296-298 160 160 208-206H640v-80h240v240h-80v-104L536-320 376-480 136-240Z"/></svg>Overview</h1>
        <div class="board-1">
            <div class="div">
                <h1>
                ...
                <h2>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m136-240-56-56 296-298 160 160 208-206H640v-80h240v240h-80v-104L536-320 376-480 136-240Z"/></svg> 37% 
                    </span> 
            ...
            <div class="div">
                ...
                <h2>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m136-240-56-56 296-298 160 160 208-206H640v-80h240v240h-80v-104L536-320 376-480 136-240Z"/></svg> 90% 
                    </span> 
                    <span>Since last month</span>
                </h2>
            </div> 
            <div class="div">
                ...
                <h2>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m136-240-56-56 296-298 160 160 208-206H640v-80h240v240h-80v-104L536-320 376-480 136-240Z"/></svg> 24% 
                    </span> 
                    <span>Since last month</span>
                </h2>
            </div> 
        ...
        <div class="board-2">
            <div class="div">
                ...
                <div class="canvas"> 
                    <div class="inner-x">
                        <span>Last month</span><span style="height: 1em; width: 50%; background: rgb(138, 18, 18)"></span>
                    </div>
                    <div class="inner-x">
                        <span>2 months</span><span style="height: 1em; width: 20%; background: rgb(71, 125, 58)"></span>
                    </div>
                    <div class="inner-x">
                        <span>3 months</span><span style="height: 1em; width: 75%; background: rgb(75, 54, 121)"></span>
                    </div>
                    <div class="inner-x">
                        <span>4 months</span><span style="height: 1em; width: 55%; background: rgb(51, 117, 137)"></span>
                    </div>
                </div>
            </div>
            <div class="div">
