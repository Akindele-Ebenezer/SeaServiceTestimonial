...
{ 
    public function small_boat_report(Fpdf $fpdf, Request $Request) {  
        ...
        $fpdf->Cell(38, 6, 'Apapa Dockyard Rd', 'LBR', 0, 'C');
        $fpdf->Cell(38, 6, '2024-11-04', 'LBR', 0, 'C');
        $fpdf->Cell(38, 6, 'SEA FOX', 'LBR', 0, 'C');
        $fpdf->Cell(38, 6, 'THOMPSON OYINMI', 'LBR', 0, 'C');
        $fpdf->Cell(38, 6, 'Christopher Oluwayomi', 'LBR', 0, 'C');
