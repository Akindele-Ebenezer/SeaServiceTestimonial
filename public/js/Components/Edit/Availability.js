...
EditAvailabilityButtons.forEach(EditAvailabilityButton => {
    EditAvailabilityButton.addEventListener('click', () => {
        ...
        // document.querySelector('.UpdateAvailabilityForm input[name=EditReport]').value = EditAvailabilityButton.parentElement.parentElement.firstElementChild.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.textContent;
        // document.querySelector('.UpdateAvailabilityForm input[name=EditPicture]').value = EditAvailabilityButton.parentElement.parentElement.firstElementChild.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.textContent;
